...
<!--seccion de barra de navegacion-->
	...
	<nav role="navigation" class="navbar navbar-default fixed">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse fix">
...
<div class="container">
  <div class="row">
        ...
        <div id="thumbcarousel" class="carousel slide" data-interval="false">
            <div class="carousel-inner ">
                <div class="item active">
                    <div data-target="#carousel" data-slide-to="0" class="thumb col-md-4"><img src="http://placehold.it/100/e8117f/fff&amp;text=Product+Main"></div>
                    <div data-target="#carousel" data-slide-to="1" class="thumb col-md-4"><img src="http://placehold.it/100/00ffff/000&amp;text=Product+Image+2"></div>
                    <div data-target="#carousel" data-slide-to="2" class="thumb col-md-4"><img src="http://placehold.it/100/ff00ff/fff&amp;text=Product+Image+3"></div>
                    <div data-target="#carousel" data-slide-to="1" class="thumb col-md-4"><img src="http://placehold.it/100/00ffff/000&amp;text=Product+Image+2"></div>
                    
                </div><!-- /item -->
                <div class="item">
                <div data-target="#carousel" data-slide-to="3" class="thumb col-md-4"><img src="http://placehold.it/100/ffff00/000&amp;text=Product+Image+4"></div>
                    <div data-target="#carousel" data-slide-to="4" class="thumb col-md-4"><img src="http://placehold.it/100/612b65/fff&amp;text=Product+Image+5"></div>
                    <div data-target="#carousel" data-slide-to="5" class="thumb col-md-4"><img src="http://placehold.it/100/00ffcc/000&amp;text=Product+Image+6"></div>
                    <div data-target="#carousel" data-slide-to="5" class="thumb col-md-4"><img src="http://placehold.it/100/00ffcc/000&amp;text=Product+Image+6"></div>
                </div><!-- /item -->
            </div><!-- /carousel-inner -->
	...
	<div class="my-work text-center " id="my-work">
	<div class="imagenes6 row">
		...
		<div class="imagen-work col-md-4">
				...
				<div class="contenido-interno1">
					<h3>Descripcion</h3>
					<p> I can't give you this case, it don't belong to me. </p>
				</div>
				</div>
